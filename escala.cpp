...
// --------------------
   ...
   // ourShader.setInt("texture2", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float scale = 1.0f - sin(glfwGetTime()) * 0.5f;
        ...
        float scale2 = 1.0f + cos(glfwGetTime()) * 0.5f;
        int scaleLocation2 = glGetUniformLocation(shaderProgram, "scale");
        glUniform1f(scaleLocation2, scale2);
