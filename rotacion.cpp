...
// --------------------
   ...
   // ourShader.setInt("texture2", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float angle = (float)glfwGetTime() * 50.0f; // Angulo de rotación
        glm::mat4 transform = glm::mat4(1.0f);
        // Obtener el centro del triángulo
        glm::vec3 center = glm::vec3((vertices[0] + vertices[3] + vertices[6]) / 3.0f,
            (vertices[1] + vertices[4] + vertices[7]) / 3.0f,
            (vertices[2] + vertices[5] + vertices[8]) / 3.0f);;
